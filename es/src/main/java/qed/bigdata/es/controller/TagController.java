...
public class TagController {
    ...
    public JSONObject searchDicomByTag(HttpServletRequest request, HttpServletResponse response, @RequestBody Map<String, String> parametr) {
        ...
        obj.put(SysConstants.KEYWORD,SysConstants.TAG);
        obj.put(SysConstants.VALUE,tag);
        criteria.add(obj);
        ...
        JSONObject tempResult = searchService.searchDicomByPaging(criteria, backfields,sortfields,1, SysConstants.DEFAULT_PAGE_SIZE);
