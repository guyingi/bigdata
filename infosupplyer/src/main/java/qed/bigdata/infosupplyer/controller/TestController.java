...
//        JSONObject json = new JSONObject();
//        String deviceType = (String)param.get(EsConsts.DEVICE_PARAM);
//        if(deviceType !=null && deviceType.length()!=0)
//            json.put(EsConsts.ManufacturersModelName_ES_DCM,deviceType);
//        String organ = (String)param.get(EsConsts.ORGAN_ES_DCM);
//        if(organ !=null && organ.length()!=0)
//            json.put(EsConsts.ORGAN_ES_DCM,organ);
//        String hospital =(String)param.get(EsConsts.INSTITUTION_PARAM);
//        if(hospital !=null && hospital.length()!=0)
//            json.put(EsConsts.InstitutionName_ES_DCM,hospital);
//        String mrisequence =(String)param.get(EsConsts.SERIES_DESCRIPTION_PARAM);
//        if(mrisequence !=null && mrisequence.length()!=0)
//            json.put(EsConsts.SeriesDescription_ES_DCM,mrisequence);
//        String sex =(String)param.get(EsConsts.SEX_PARAM);
//        if(sex !=null && sex.length()!=0)
//            json.put(EsConsts.PatientsSex_ES_DCM,sex);
//        String ageStartParam=(String)param.get(EsConsts.AGE_START_PARAM);
//        if(ageStartParam !=null && ageStartParam.length()!=0)
//            json.put(EsConsts.AGE_START_PARAM,ageStartParam);
//        String ageEndParam=(String)param.get(EsConsts.AGE_END_PARAM);
//        if(ageEndParam !=null && ageEndParam.length()!=0)
//            json.put(EsConsts.AGE_END_PARAM,ageEndParam);
//        String studyDateStartParam =(String)param.get(EsConsts.STUDYDATE_START_PARAM);
//        if(studyDateStartParam !=null && studyDateStartParam.length()!=0)
//            json.put(EsConsts.STUDYDATE_START_PARAM,studyDateStartParam);
//        String studyDateEndParam =(String)param.get(EsConsts.STUDYDATE_END_PARAM);
//        if(studyDateEndParam !=null && studyDateEndParam.length()!=0)
//            json.put(EsConsts.STUDYDATE_END_PARAM,studyDateEndParam);
//        String entryDateStartParam =(String)param.get(EsConsts.ENTRYDATE_START_PARAM);
//        if(entryDateStartParam !=null && entryDateStartParam.length()!=0)
//            json.put(EsConsts.ENTRYDATE_START_PARAM,entryDateStartParam);
//        String entryDateEndParam =(String)param.get(EsConsts.ENTRYDATE_END_PARAM);
//        if(entryDateEndParam !=null && entryDateEndParam.length()!=0)
//            json.put(EsConsts.ENTRYDATE_END_PARAM,entryDateEndParam);
//        return json;
//    }
