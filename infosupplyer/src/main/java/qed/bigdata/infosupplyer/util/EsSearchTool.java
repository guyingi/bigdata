package qed.bigdata.infosupplyer.util;//package yasen.bigdata.infosupplyer.util;
//
...
////        json.put(EsConsts.HOSPITAL,hos);
//        json.put(EsConsts.SEX,se);
////        json.put(EsConsts.MRISEQ,mri);
...
//                    String batchseq = (String) sourceAsMap.get(EsConsts.BATCHSEQ);
...
//                        list.add(sourceAsMap.get(EsConsts.HDFSPATH_ES));
...
//        String mriSeq = searchFieldJson.getString(EsConsts.MRISEQ);
//        if(mriSeq != null && mriSeq.length()!=0){
//            //此处使用termsQuery(String name,String value)精确匹配单个值
//            matchQueryList.add(QueryBuilders.matchQuery(EsConsts.MRISEQ, mriSeq));
//        }
//        String sex = searchFieldJson.getString(EsConsts.SEX);
//        if(sex != null && sex.length()!=0){
//            //此处使用termsQuery(String name,String value)精确匹配单个值
//            matchQueryList.add(QueryBuilders.matchQuery(EsConsts.SEX, sex));
//        }
//
//        //范围值的字段：年龄段，检查日期段，数据收入日期段
//        // 查询在时间区间范围内的结果
//        //年龄段
//        String ageSection = searchFieldJson.getString(EsConsts.AGE_SECTION);
...
//        String studyDateSection = searchFieldJson.getString(EsConsts.STUDYDATE_SECTION);
...
//        }
//        //数据收入日期段
//        String entryDateSection = searchFieldJson.getString(EsConsts.ENTRYDATE_SECTION);
...
//        String deviceName = searchFieldJson.getString(EsConsts.DEVICENAME);
//        if(deviceName != null && deviceName.length()!=0){
//            //此处使用termsQuery(String name,String ...values)同时匹配多个值
//            matchQueryList.add(QueryBuilders.matchQuery(EsConsts.DEVICENAME,deviceName ));
//        }
//        String hospital = searchFieldJson.getString(EsConsts.HOSPITAL);
//        if(hospital != null && hospital.length()!=0){
//            //此处使用termsQuery(String name,String ...values)同时匹配多个值
//            matchQueryList.add(QueryBuilders.matchQuery(EsConsts.HOSPITAL, hospital));
//        }
//        String organ = searchFieldJson.getString(EsConsts.ORGAN_ES_DCM);
//        if(organ != null && organ.length()!=0){
//            //此处使用termsQuery(String name,String ...values)同时匹配多个值
//            matchQueryList.add(QueryBuilders.matchQuery(EsConsts.ORGAN_ES_DCM, organ));
//        }
//
//        // 等同于bool，将两个查询合并
...
//        //枚举值的字段：设备种类，数据来源（医院），扫描部位
//
//        String deviceType = searchFieldJson.getString(EsConsts.DEVICENAME);
//        if(deviceType != null && deviceType.length()!=0){
//            //此处使用termsQuery(String name,String ...values)同时匹配多个值
//            matchQueryList.add(QueryBuilders.matchQuery(EsConsts.DEVICENAME,deviceType ));
//        }
//        String hospital = searchFieldJson.getString(EsConsts.HOSPITAL);
//        if(hospital != null && hospital.length()!=0){
//            //此处使用termsQuery(String name,String ...values)同时匹配多个值
...
////        JsonObject json = new JsonObject();
////        json.addProperty(EsConsts.ID_ES_DCM,id);
