...
//                .getPath();
        ...
        System.out.println("dbsjjhdbsjbd");
...
//        SortBuilder sortBuilder1 = new FieldSortBuilder(EsConsts.InstitutionName_ES_DCM).order(SortOrder.DESC);
//        SortBuilder sortBuilder2 = new FieldSortBuilder(EsConsts.ORGAN_ES_DCM).order(SortOrder.DESC);
//        SortBuilder sortBuilder3 = new FieldSortBuilder(EsConsts.PatientName_ES_DCM).order(SortOrder.DESC);
//        SortBuilder sortBuilder4 = new FieldSortBuilder(EsConsts.SeriesDate_ES_DCM).order(SortOrder.DESC);
//        SortBuilder sortBuilder5 = new FieldSortBuilder(EsConsts.SeriesDescription_ES_DCM).order(SortOrder.DESC);
//        SortBuilder sortBuilder6 = new FieldSortBuilder(EsConsts.NumberOfSlices_ES_DCM).order(SortOrder.DESC);
...
//        json.put(EsConsts.InstitutionName_ES_DCM,sourceAsMap.get(EsConsts.InstitutionName_ES_DCM));
//        json.put(EsConsts.ORGAN_ES_DCM,sourceAsMap.get(EsConsts.ORGAN_ES_DCM));
//        json.put(EsConsts.PatientName_ES_DCM,sourceAsMap.get(EsConsts.PatientName_ES_DCM));
//        json.put(EsConsts.SeriesDescription_ES_DCM,sourceAsMap.get(EsConsts.SeriesDescription_ES_DCM));
//        json.put(EsConsts.SeriesDate_ES_DCM,sourceAsMap.get(EsConsts.SeriesDate_ES_DCM));
//        json.put(EsConsts.NumberOfSlices_ES_DCM,sourceAsMap.get(EsConsts.NumberOfSlices_ES_DCM));
        return json;
    }
